...
class AdminHeaderView {
    ...
    public static function render(string $activeTitle = '', string $subtitle = ''): void {
        ...
        $isProActive = \NextGen\Core\Features::isProActive();
        ?>
                ...
                <div class="nextgen-brand">
                    ...
                    <div class="nextgen-brand-meta">
                        <div class="nextgen-brand-title-row">
                            ...
                            <?php if ($isProActive): ?>
                                <span class="nextgen-edition-badge nextgen-edition-pro" style="background:#16a34a;color:#fff;font-weight:600;"><?php esc_html_e('Pro Active', 'hridyaa-image-compressor-and-optimizer'); ?></span>
                            <?php else: ?>
